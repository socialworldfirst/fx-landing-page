...
export default function Home() {
  return (
    <main>
      ...
      <section className="relative bg-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-wf-text-secondary text-lg md:text-xl mt-6 max-w-2xl">
      ...
      {/* Section 2: Trust Bar */}
      <section className="bg-wf-bg-light py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-semibold text-wf-text tracking-tight">40+</p>
              <p className="text-sm text-wf-text-muted mt-1">Currencies supported</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-semibold text-wf-text tracking-tight">90%</p>
              <p className="text-sm text-wf-text-muted mt-1">CNY payments arrive same day</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-semibold text-wf-text tracking-tight">150K+</p>
              <p className="text-sm text-wf-text-muted mt-1">Businesses trust WorldFirst</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-semibold text-wf-text tracking-tight">20+ yrs</p>
              <p className="text-sm text-wf-text-muted mt-1">Powering global trade since 2004</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-wf-border p-6 card-hover">
      ...
      {/* Section 4: China Payments Deep Dive */}
      <section id="china-payments" className="bg-wf-bg-light py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            {/* Image placeholder */}
            <div className="w-full lg:w-1/2">
              <div className="bg-white rounded-3xl border border-wf-border p-8 lg:p-12">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-wf-red flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-wf-success flex items-center justify-center">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-wf-text-muted">Rate</span>
                    <span className="font-medium text-wf-text">1 GBP = 9.2060 CNY</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-wf-text-muted">Bank would charge</span>
                    <span className="font-medium text-wf-red line-through">1 GBP = 8.9400 CNY</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-wf-text-muted">You saved</span>
                    <span className="font-semibold text-wf-success">£723 on this transfer</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Text */}
            <div className="w-full lg:w-1/2">
              <h2 className="text-2xl md:text-3xl font-semibold text-wf-text tracking-tight mb-6">
                Built for Businesses That <span className="accent-word">Pay China</span>
              </h2>
              <p className="text-wf-text-secondary mb-8">
                Most payment platforms treat China like any other country. We built ours specifically for it. As part of the Ant Group ecosystem — the company behind Alipay and 1688.com — WorldFirst connects you directly to Chinese financial infrastructure.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  <span className="mt-1 w-5 h-5 rounded-full bg-wf-red/10 flex-shrink-0 flex items-center justify-center">
                    <span className="w-2 h-2 rounded-full bg-wf-red" />
                  </span>
                  <div>
                    <p className="font-medium text-wf-text">Same-day CNY</p>
                    <p className="text-sm text-wf-text-secondary">90% of payments to China clear the same day through our exclusive banking network</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 w-5 h-5 rounded-full bg-wf-red/10 flex-shrink-0 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-medium text-wf-text">1688 World Pay</p>
                    <p className="text-sm text-wf-text-secondary">The official checkout for 1688.com — pay in your currency, suppliers receive CNY instantly</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 w-5 h-5 rounded-full bg-wf-red/10 flex-shrink-0 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-medium text-wf-text">No middlemen</p>
                    <p className="text-sm text-wf-text-secondary">Skip the sourcing agent. Pay suppliers directly, securely, and compliantly</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 w-5 h-5 rounded-full bg-wf-red/10 flex-shrink-0 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-medium text-wf-text">Collect and pay</p>
                    <p className="text-sm text-wf-text-secondary">Receive marketplace payouts in 40+ currencies and pay suppliers from the same World Account</p>
                  </div>
                </li>
              </ul>
              <a
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-wf-border p-6 text-center">
              <div className="w-12 h-12 rounded-2xl bg-wf-bg-light flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-wf-text" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
      ...
      {/* Section 6: FAQ */}
      <section id="faq" className="bg-wf-bg-light py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-semibold text-wf-text tracking-tight text-center mb-12">
            Common Questions
          </h2>
      ...
      <section className="bg-wf-text py-16 lg:py-24">
